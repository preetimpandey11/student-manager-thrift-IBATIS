...
public class Student implements org.apache.thrift.TBase<Student, Student._Fields>, java.io.Serializable, Cloneable, Comparable<Student> {
  ...
  private static final org.apache.thrift.protocol.TField STANDARD_FIELD_DESC = new org.apache.thrift.protocol.TField("standard", org.apache.thrift.protocol.TType.I32, (short)3);
  private static final org.apache.thrift.protocol.TField DIVISION_FIELD_DESC = new org.apache.thrift.protocol.TField("division", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  public int standard; // optional
  /**
   * 
   * @see Division
   */
  public @org.apache.thrift.annotation.Nullable Division division; // optional
  ...
  private static final int __STANDARD_ISSET_ID = 1;
  private static final int __SCORE_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.STANDARD,_Fields.DIVISION,_Fields.SCORE};
  ...
  static {
    ...
    tmpMap.put(_Fields.STANDARD, new org.apache.thrift.meta_data.FieldMetaData("standard", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.DIVISION, new org.apache.thrift.meta_data.FieldMetaData("division", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, Division.class)));
  ...
  public Student setStandard(int standard) {
    ...
    setStandardIsSet(true);
    return this;
  }

  public void unsetStandard() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __STANDARD_ISSET_ID);
  }

  /** Returns true if field standard is set (has been assigned a value) and false otherwise */
  public boolean isSetStandard() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __STANDARD_ISSET_ID);
  }

  public void setStandardIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __STANDARD_ISSET_ID, value);
  }
   ...
   * @see Division
   */
  public Student setDivision(@org.apache.thrift.annotation.Nullable Division division) {
  ...
  /** Returns true if field division is set (has been assigned a value) and false otherwise */
  public boolean isSetDivision() {
    return this.division != null;
  }

  public void setDivisionIsSet(boolean value) {
    if (!value) {
      this.division = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case STANDARD:
      if (value == null) {
        ...
        setStandard((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(Student that) {
    ...
    boolean this_present_division = true && this.isSetDivision();
    boolean that_present_division = true && that.isSetDivision();
    if (this_present_division || that_present_division) {
      if (!(this_present_division && that_present_division))
        return false;
      if (!this.division.equals(that.division))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetStandard())
      hashCode = hashCode * 8191 + standard;

    hashCode = hashCode * 8191 + ((isSetDivision()) ? 131071 : 524287);
    if (isSetDivision())
      hashCode = hashCode * 8191 + division.getValue();
  ...
  public int compareTo(Student other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetDivision()).compareTo(other.isSetDivision());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDivision()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.division, other.division);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class StudentStandardScheme extends org.apache.thrift.scheme.StandardScheme<Student> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Student struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // DIVISION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.division = com.student.Division.findByValue(iprot.readI32());
              struct.setDivisionIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Student struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetStandard()) {
        ...
        oprot.writeI32(struct.standard);
        oprot.writeFieldEnd();
      }
      if (struct.division != null) {
        if (struct.isSetDivision()) {
          oprot.writeFieldBegin(DIVISION_FIELD_DESC);
          oprot.writeI32(struct.division.getValue());
          oprot.writeFieldEnd();
        }
      }
